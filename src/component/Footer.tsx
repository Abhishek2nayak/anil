...
export default function Footer() {
  return (
    <div className="relative mt-16 bg-dark border-t-2 border-yellow-500 bg-[#420c14]">
        ...
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2 text-white">
            <div className="flex gap-2 items-center">
              <img
                ...
                height={100}
              />
              <h3 className="text-3xl font-bold text-white">Prince Mehndi</h3>
            </div>
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex">
              ...
              <p className="text-white">Madurai</p>
            </div>
          </div>
          <div>
            <p className=" font-bold tracking-wide text-white">Social</p>
